...
namespace NetMX.Relation
{
   ...
   public interface RelationServiceMBean
   {
      ...
      /// <param name="roleTypeName">Name of the relation type (has to be created in the Relation Service)</param>
      ...
      /// </list>
      /// </exception>
      void CreateRelation(string relationId, string roleTypeName, IEnumerable<Role> roles);
      /// <summary>
