...
namespace NetMX.OpenMBean.Mapper
{
   ...
   public delegate object MapValueDelegate(Type plainNetType, OpenType mappedType, object value);
   ...
   public interface ITypeMapper
   {
      ...
      object MapValue(Type plainNetType, OpenType mappedType, object value, MapValueDelegate mapNestedValueCallback);
   }
}
