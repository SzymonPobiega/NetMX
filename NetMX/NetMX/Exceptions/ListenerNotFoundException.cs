...
namespace NetMX
{
	...
	public sealed class ListenerNotFoundException : OperationsException
	{
		...
		public ListenerNotFoundException(string objectName)
			:
			 base(string.Format(CultureInfo.CurrentCulture, "Listener was not found in MBean \"{0}\"", objectName))
		{
			_objectName = objectName;
		}

		private ListenerNotFoundException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{			
