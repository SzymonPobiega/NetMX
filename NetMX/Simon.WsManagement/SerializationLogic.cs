...
{      
   ...
   public partial class Enumerate
   {
      ...
      public Enumerate(bool optimized, EnumerationMode? mode)
      {                
         if (optimized)
         {
   ...
   public partial class EnumerateResponse
   {
      ...
      [XmlArrayItem(ElementName = "AddressReference", Type = typeof(EndpointAddress10), Namespace = WsAddressing.Namespace)]
