       ...
       public SampleDynamicMBean()
        {
            ...
            CompositeType innerRowType = new CompositeType("Row", "Row", new string[] { "ID", "Name" }, new string[] { "Unique ID", "Name" }, new OpenType[] { SimpleType.Integer, SimpleType.String });
        ...
        {
           CompositeDataSupport innerRow = new CompositeDataSupport(_innerTabularType.RowType, new string[] { "ID", "Name" }, new object[] { outerId, name });
