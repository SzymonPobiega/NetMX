<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebClientDemo._Default" %>
...
<body>
	<form id="form1" runat="server">
		...
		<nwc:MBeanServerProxy ID="proxy" runat="server" ServiceUrl="net.pipe://localhost/MBeanServer" />
		...
		<asp:MultiView ID="view" runat="server" ActiveViewIndex="0">
		    ...
		    <asp:View ID="details" runat="Server">
		        <nwc:MBeanUI ID="beanUI" runat="server" MBeanServerProxyID="proxy" 
