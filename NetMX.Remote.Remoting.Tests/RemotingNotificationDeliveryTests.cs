...
{
    [TestFixture]
    public class RemotingNotificationDeliveryTests : NotificationDeliveryTests
    {
        ...
        {
            return new RemotingConnectorFactory(new NotificationFetcherConfig(true, TimeSpan.FromSeconds(1)));
        }
    }
}